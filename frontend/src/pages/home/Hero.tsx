  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      <div ref={containerRef} className="absolute inset-0 z-0 flex items-center justify-center">
        ...
        <div className="w-full h-full md:w-auto md:h-auto" style={{
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          Deliver fast, clean, and fully customized application and business solutions with our AI-driven development process.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link to="/demo" className="bg-blue-500 text-white px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-blue-600 transition-colors duration-300 text-base md:text-lg font-semibold">
            Contact us
          </Link>
          <Link to="/whitepaper" className="bg-transparent border-2 border-white text-white px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-white hover:text-blue-900 transition-colors duration-300 text-base md:text-lg font-semibold">
            More
          </Link>
        </motion.div>
      </div>
